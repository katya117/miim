...
to setup
  ...
  set z1 round(random-exponential 38)
  set z2 round(random-exponential 30)
  set z3 round(random-exponential 25)
  set num 0
end

to setup-patches
  ask patches [ set pcolor 75]

  ask patches with [ pycor = -1]

  [
    set pcolor blue
      if (pxcor = ( - startposition1))
      [
      set pcolor   blue + 2
      ]
      if (pxcor = (- startposition2))
      [
      set pcolor   blue + 3
      ]
    if (pxcor = (- startposition3))
      [
        set pcolor   blue + 4
      ]
  ]
...
624
142
количество портов 1 типа
abs(startposition2 - startposition1)
17
1
11
...
817
140
количество портов 2 типа
abs(startposition2 - startposition3)
17
1
11
...
1006
139
количетсво портов 3 типа
abs(20 - startposition3)
17
1
11
