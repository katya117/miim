...
globals [ slow? speed zakaz-reprint ]       
breed [ services servicek ]
breed [ zakas zakaz ]
turtles-own [ knowledge ]
breed [ telephones telephone ]
to setup
  clear-all
  set-default-shape telephones "telephone"
  create-ordered-telephones dispet
  [
    set size 3
    set color pink
     fd 8
  ]
 set-default-shape zakas "box"
  create-ordered-zakas dispet
  [
    set size 3
      fd 10
      set color 103
  ...
  set-default-shape services  "person"
...
to reprint-zakas
 set  zakaz-reprint 12
if random-poisson 20 < zakaz-reprint [
set knowledge ( knowledge / 4 )
hatch 1 [  fd 1 set color red]
]
end
...
This project is inspired by a  model: Wolf Sheep Predation and others. In the model students from Polish-Japanese Institute of Information Technology have to learn before exams. They wander randomly while professors are observing them.
Only one of them circulate trying to catch and fail every student encountered. 
...
The INITIAL-NUMBER-STUDENTS  slider sets the number of students at the beginning of exam session. The INITIAL-NUMBER-BOOKS slider determines how many books will be created when the SETUP button pressed. Note that this value only affects the model at setup.
...
Watch the POPULATIONS plot to see how the students population changes over time.
The student can fail the exams and die if he will not reading books and learn. At first if there are not enough books for the students, they will fail their exams and die. Notice that their level of knowledge depends on number of books read. Number of books can increase using BOOK-REPRINT slider. 

Why do you suppose that some variations of the model might be stable while others are not?

## THINGS TO TRY

Try adjusting the parameters under various setting.
Can you find any parameters that generate a stable number of students and books?
...
Polygon -13345367 true false 105 90 105 195 105 285 105 300 135 300 150 225 165 300 195 300 195 285 195 195 195 90
Rectangle -13345367 true false 127 79 172 94
Polygon -13345367 true false 195 90 240 150 225 180 165 105
Polygon -13345367 true false 105 90 60 150 75 180 135 105
Polygon -1 true false 120 180 150 105 180 180 165 180 150 135 135 180 120 180
...
false
0
Polygon -11221820 true false 30 195 150 255 270 135 150 75
Polygon -11221820 true false 30 135 150 195 270 75 150 15
Polygon -11221820 true false 30 135 30 195 90 150
...
Polygon -1184463 true false 105 90 90 195 105 285 105 300 135 300 150 225 165 300 195 300 195 285 195 195 195 90
Rectangle -2674135 true false 127 79 172 94
Polygon -1184463 true false 195 90 240 150 240 180 165 105
Polygon -1184463 true false 105 90 45 165 60 180 135 105
Circle -1 true false 135 120 30
Circle -1 true false 135 165 30
Polygon -1 true false 105 30 135 30 135 45 105 45 105 15
Rectangle -1 true false 150 30 180 45
Circle -16777216 false false 135 120 30
Circle -16777216 false false 135 165 30
Rectangle -16777216 false false 105 30 135 45
Rectangle -16777216 false false 150 30 180 45
...
Polygon -2064490 true false 105 90 60 195 90 210 135 105
...
Polygon -13840069 true false 105 90 120 195 105 285 105 300 135 300 150 195 165 300 195 300 195 285 195 195 195 90
...
Line -955883 false 120 30 75 60
Line -2674135 false 135 30 75 90
Line -955883 false 150 15 225 75
Line -955883 false 180 15 210 120
Line -955883 false 135 15 105 120
Polygon -955883 true false 120 105 135 195 165 150 180 195 195 120 180 105 180 150 165 135 150 150 120 105
